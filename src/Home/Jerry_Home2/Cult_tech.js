...
import technical1 from "./Images/tech_red.png"
    ...
    return (
        <>
            <div className="cult_tech_box je_100width" style={{overflowX:"hidden"}}>
                <h1 id="home_heading_contact" data-aos="fade-right" className=' event_head_home'><span style={{color:"rgb(201 23 23)"}}>E</span>vents</h1>
